...
export const getBrainTreeClientToken = (userId) =>{
    return fetch(`https://localhost:5000/api/braintree/getToken/${userId}`,{
        method:"GET"
...
export const processPayment = (userId,paymentData) =>{
     ...
     return fetch(`https://localhost:5000/api/braintree/payment/${userId}`,{
        method:"POST",
        body:JSON.stringify({
            paymentData
        })
...
export const createOrder = (userId,createOrderData) => {
    ...
    return fetch(`https://localhost:5000/api/order/create/${userId}`,{
        method:"POST",
        headers:{

...
export const getBrainTreeClientToken = (userId) =>{
    return fetch(`https://artq-api-rum-n.vercel.app/api/braintree/getToken/${userId}`,{
        method:"GET"
...
export const processPayment = (userId,paymentData) =>{
     ...
     return fetch(`https://artq-api-rum-n.vercel.app/api/braintree/payment/${userId}`,{
        method:"POST",
        body:JSON.stringify({
            paymentData
        })
...
export const createOrder = (userId,createOrderData) => {
    ...
    return fetch(`https://artq-api-rum-n.vercel.app/api/order/create/${userId}`,{
        method:"POST",
        headers:{

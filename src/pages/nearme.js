      ...
      content: 
        `<Modal>
          ...
          <Modal.Body>
            ...
            <Row>
            <Col xs={12} md={6}>
              <img className='map-modal-img' src=${`https://artq-pi.vercel.app/${dataArrayimage[i]}`} alt={activeItem.name}/>
            </Col>
            <Col xs={12} md={6}>
      ...
      {data && <div className='artist-location'>
        {uorder.map(artists => {
          ...
          <div key={artists.id} className='artist-location-info'>
            <img className='near-artist-img' src={`https://artq-pi.vercel.app/${artists.url}`} alt={artists.title}/>
            <div>
              <p>{artists.title}</p>

  ...
  const auth = useContext(AuthContext);
    ...
    const getthebuyer = async (o,oIndex) => {
        try {
          ...
          const response =  await fetch(`https://localhost:5000/api/users/${o.artistid}`);
          const responseData = await response.json();
    ...
    const placeSubmitHandler = async (o,e) => {
        ...
        await sendRequest(`https://localhost:5000/api/order/${o._id}/status/${o.user1}`,'PUT',JSON.stringify({
            orderId : o._id,
